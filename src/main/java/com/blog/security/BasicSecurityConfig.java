...
public class BasicSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                .antMatchers("/usuario/logar").permitAll() // não preciso de token, acessa o banco para verificar
                .antMatchers("/usuario/cadastrar").permitAll() // não preciso de token, acessa o banco para verificar
